    ...
    while not fringe.isEmpty():
        ...
        if state not in explored:
            ...
            for next_state,next_action,next_cost in problem.getSuccessors(state):
                fringe.push((next_state,action+[next_action],cost +next_cost))
...
def uniformCostSearch(problem: SearchProblem):
    ...
    while not fringe.isEmpty():
        ...
        if state not in explored:
            explored.append(state)
            for next_state,next_action,next_cost in problem.getSuccessors(state):
                fringe.push((next_state,action+[next_action],cost +next_cost),cost+next_cost)
    ...
    while not fringe.isEmpty():
        ...
        if state not in explored:
            ...
            for next_state,next_action,next_cost in problem.getSuccessors(state):
                ...
                fringe.push((next_state,action+[next_action],cost+next_cost),cost+next_cost+next_heur)
